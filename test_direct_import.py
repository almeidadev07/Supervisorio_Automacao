#!/usr/bin/env python3
"""
Teste Direto do Controlador PLC Simples e Robusto
Importa diretamente o arquivo sem passar pelo __init__.py
"""
...
def test_simple_robust_controller():
    ...
    print("=" * 60)
    print("TESTE DIRETO DO CONTROLADOR PLC SIMPLES E ROBUSTO")
    print("=" * 60)
    ...
    # Importa diretamente o arquivo Python
    import importlib.util
    spec = importlib.util.spec_from_file_location(
        "plc_controller_simple_robust", 
    ...
    # Cria controlador
    controller = module.SimpleRobustPLCController(MockSocketIO(), machines_config)
